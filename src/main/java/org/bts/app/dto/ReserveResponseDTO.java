 ...
 *
 * @param ticketNumber Unique booking identifier generated for the reservation.
 ...
 */
public record ReserveResponseDTO(String ticketNumber, TripDetailsDTO tripDetails, List<Seat> assignedSeats, Double totalPrice) {
    }
